...
import com.example.test6.databinding.ActivityDbcBinding;

public class DBC extends AppCompatActivity {

    private AppBarConfiguration appBarConfiguration;
private ActivityDbcBinding binding;
    ActivityDbcBinding binding_nav;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dbc);
        binding_nav = ActivityDbcBinding.inflate(getLayoutInflater());
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DBC.this, MainActivity.class));
            }
        });
